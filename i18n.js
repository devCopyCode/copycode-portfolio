...
(function () {
  ...
  const translations = {
    'pt-BR': {
      ...
      project2Category: 'Criativo',
      project2Title: 'Portfólio para Designer',
      project2Text: 'Showcase minimalista para apresentar trabalhos e captar novos clientes.',

      project3Category: 'E-commerce',
      project3Title: 'Site para Loja de Roupas',
      project3Text: 'Vitrine digital com catálogo, filtros e contato direto para vendas.',

      project4Category: 'Jurídico',
      project4Title: 'Página para Advogado',
      project4Text: 'Site institucional com áreas de atuação, credibilidade e formulário de contato.',

      project5Category: 'Academia',
      project5Title: 'Site para Academia de Luta',
      project5Text: 'Site para academia de Muay Thai e Boxe com horários de aula, instrutores e agendamento de aula experimental.',

      project6Category: 'Saúde Pet',
      project6Title: 'Site para Plano de Saúde Pet',
      project6Text: 'Landing page para plano de saúde pet com tabela de coberturas, planos, depoimentos e agendamento via WhatsApp.',
      ...
      plansPreviewEssDesc: 'Ideal para profissionais autônomos, pequenos negócios, restaurantes, barbearias e empresas que precisam iniciar sua presença digital.',
      plansPreviewEssInfo: 'Permanência mínima de 12 meses.',
      plansPreviewEss1: 'Página única com até 5 seções',
      plansPreviewEss2: 'Design moderno e responsivo',
      plansPreviewEss3: 'Integração com WhatsApp',
      plansPreviewEss4: 'Formulário de contato',
      plansPreviewEss5: 'Google Maps e redes sociais',
      plansPreviewEss6: 'SEO básico',
      plansPreviewEss7: 'Domínio e hospedagem',
      plansPreviewEss8: 'Manutenção e suporte',
      plansPreviewEss9: 'Até 2 pequenas alterações por mês',
      plansPreviewEssOneTime: 'Compra definitiva: R$ 1.100',
      plansPreviewEssCta: 'Ver Site Essencial',

      plansPreviewProDesc: 'Ideal para empresas que precisam de várias páginas, melhor apresentação dos serviços, portfólio, catálogo ou recursos personalizados.',
      plansPreviewProInfo: 'Permanência mínima de 12 meses.',
      plansPreviewPro1: 'Design personalizado',
      plansPreviewPro2: 'Até 8 páginas',
      plansPreviewPro3: 'Portfólio ou galeria',
      plansPreviewPro4: 'Formulários personalizados',
      plansPreviewPro5: 'Google Analytics',
      plansPreviewPro6: 'SEO intermediário',
      plansPreviewPro7: 'Otimização de velocidade',
      plansPreviewPro8: 'Blog, catálogo ou área de novidades',
      plansPreviewPro9: 'Domínio e hospedagem',
      plansPreviewPro10: 'Manutenção e suporte prioritário',
      plansPreviewPro11: 'Até 4 pequenas alterações por mês',
      plansPreviewProOneTime: 'Compra definitiva: R$ 2.500',
      plansPreviewProCta: 'Ver Site Profissional',

      plansPreviewAdvDesc: 'Ideal para empresas que precisam de sistemas personalizados, automações, área de clientes, pagamentos, agendamentos ou banco de dados.',
      plansPreviewAdvInfo: 'Valor definido conforme a complexidade do projeto.',
      plansPreviewAdv1: 'Design totalmente exclusivo',
      plansPreviewAdv2: 'Login e cadastro',
      plansPreviewAdv3: 'Painel administrativo',
      plansPreviewAdv4: 'Banco de dados',
      plansPreviewAdv5: 'Área exclusiva para clientes',
      plansPreviewAdv6: 'Agendamentos',
      plansPreviewAdv7: 'Pagamentos online',
      plansPreviewAdv8: 'Integrações com APIs',
      plansPreviewAdv9: 'Automações',
      plansPreviewAdv10: 'Dashboards e relatórios',
      plansPreviewAdv11: 'Segurança reforçada',
      plansPreviewAdv12: 'Hospedagem e suporte prioritário',
      plansPreviewAdvOneTime: 'Compra definitiva: a partir de R$ 5.000',
      plansPreviewAdvCta: 'Ver Site Avançado',

      plansPreviewAllText: 'Compare todos os recursos, modalidades e condições antes de escolher.',
      plansPreviewAllCta: 'Ver todos os planos',
      plansPreviewAllNote: 'Domínio, hospedagem gerenciada, manutenção e suporte incluídos conforme o plano.'
    },
    ...
    en: {
      ...
      project2Category: 'Creative',
      project2Title: 'Designer Portfolio',
      project2Text: 'Minimalist showcase to present work and attract new clients.',

      project3Category: 'E-commerce',
      project3Title: 'Clothing Store Website',
      project3Text: 'Digital storefront with catalog, filters and direct sales contact.',

      project4Category: 'Legal',
      project4Title: 'Lawyer Landing Page',
      project4Text: 'Business website with practice areas, credibility and contact form.',

      project5Category: 'Gym',
      project5Title: 'Combat Sports Gym Website',
      project5Text: 'Website for a Muay Thai and Boxing academy with class schedule, instructors and free trial booking.',

      project6Category: 'Pet Health',
      project6Title: 'Pet Health Plan Website',
      project6Text: 'Landing page for a pet health plan with coverage table, plans, testimonials and booking via WhatsApp.',
      ...
      plansPreviewEssDesc: 'Ideal for freelancers, small businesses, restaurants, barbershops and companies looking to start their digital presence.',
      plansPreviewEssInfo: 'Minimum commitment of 12 months.',
      plansPreviewEss1: 'Single page with up to 5 sections',
      plansPreviewEss2: 'Modern responsive design',
      plansPreviewEss3: 'WhatsApp integration',
      plansPreviewEss4: 'Contact form',
      plansPreviewEss5: 'Google Maps and social media',
      plansPreviewEss6: 'Basic SEO',
      plansPreviewEss7: 'Domain and hosting',
      plansPreviewEss8: 'Maintenance and support',
      plansPreviewEss9: 'Up to 2 minor changes per month',
      plansPreviewEssOneTime: 'One-time purchase: R$ 1,100',
      plansPreviewEssCta: 'View Essential Website',

      plansPreviewProDesc: 'Ideal for businesses that need multiple pages, better service presentation, portfolio, catalog or custom features.',
      plansPreviewProInfo: 'Minimum commitment of 12 months.',
      plansPreviewPro1: 'Custom design',
      plansPreviewPro2: 'Up to 8 pages',
      plansPreviewPro3: 'Portfolio or gallery',
      plansPreviewPro4: 'Custom forms',
      plansPreviewPro5: 'Google Analytics',
      plansPreviewPro6: 'Intermediate SEO',
      plansPreviewPro7: 'Speed optimization',
      plansPreviewPro8: 'Blog, catalog or news section',
      plansPreviewPro9: 'Domain and hosting',
      plansPreviewPro10: 'Priority maintenance and support',
      plansPreviewPro11: 'Up to 4 minor changes per month',
      plansPreviewProOneTime: 'One-time purchase: R$ 2,500',
      plansPreviewProCta: 'View Professional Website',

      plansPreviewAdvDesc: 'Ideal for companies that need custom systems, automation, client areas, payments, bookings or databases.',
      plansPreviewAdvInfo: 'Price defined based on project complexity.',
      plansPreviewAdv1: 'Fully exclusive design',
      plansPreviewAdv2: 'Login and registration',
      plansPreviewAdv3: 'Admin panel',
      plansPreviewAdv4: 'Database',
      plansPreviewAdv5: 'Exclusive client area',
      plansPreviewAdv6: 'Bookings',
      plansPreviewAdv7: 'Online payments',
      plansPreviewAdv8: 'API integrations',
      plansPreviewAdv9: 'Automations',
      plansPreviewAdv10: 'Dashboards and reports',
      plansPreviewAdv11: 'Enhanced security',
      plansPreviewAdv12: 'Hosting and priority support',
      plansPreviewAdvOneTime: 'One-time purchase: starting at R$ 5,000',
      plansPreviewAdvCta: 'View Advanced Website',

      plansPreviewAllText: 'Compare all features, purchase options and conditions before choosing.',
      plansPreviewAllCta: 'View all plans',
      plansPreviewAllNote: 'Domain, managed hosting, maintenance and support included according to the selected plan.'
    }
  };
